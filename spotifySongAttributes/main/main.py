import os
from utils import load_genre_cache, parse_playlist, parse_tracks, fetch_top_tracks, get_all_user_playlist_ids
...
from playlist_gen_test import generate_similarity_playlists
...
def similarity_playlists():
    ...
    if isinstance(token_info, dict):
        ...
        playlists = generate_similarity_playlists(sp, user_vector, 50)
        result = {group: pl['external_urls']['spotify'] if pl else None for group, pl in playlists.items()}
